...
class MusicLibrary(BaseTable):
    ...
    lyrics_link: Mapped[str | None]
    number_copies: Mapped[int]
    ...
    track10_link: Mapped[str | None]
    track11_link: Mapped[str | None]
    track12_link: Mapped[str | None]
    track13_link: Mapped[str | None]
